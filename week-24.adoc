...
----
╒════════════╤════════════╤════════════╤════════════╤════════════╤════════════╕
│"article.id"│"article.tit│"article.pub│"article.byl│"article.geo│"article.des│
│            │le"         │lished_date"│ine"        │_facet"     │_facet"     │
╞════════════╪════════════╪════════════╪════════════╪════════════╪════════════╡
│100000008287│"Satellite i│"2022-04-04"│"By Malachy │["Ukraine","│["Russian In│
│402         │mages show b│            │Browne, Davi│Russia","Buc│vasion of Uk│
│            │odies lay in│            │d Botti and │ha (Ukraine)│raine (2022)│
│            │ Bucha for w│            │Haley Willis│","Kyiv (Ukr│","Civilian │
│            │eeks, despit│            │"           │aine)"]     │Casualties"]│
│            │e Russian cl│            │            │            │            │
│            │aims."      │            │            │            │            │
├────────────┼────────────┼────────────┼────────────┼────────────┼────────────┤
│100000008090│"Grammys 202│"2022-04-03"│"By Shivani │[]          │["Grammy Awa│
│218         │2 Winners: T│            │Gonzalez"   │            │rds","Gospel│
│            │he Complete │            │            │            │ Music","Fol│
│            │List"       │            │            │            │k Music","Cl│
│            │            │            │            │            │assical Musi│
│            │            │            │            │            │c","Pop and │
│            │            │            │            │            │Rock Music",│
...
----
╒══════════════════════════════════════╤══════════════════════════════════════╤═════════╕
│"a1.title"                            │"a2.title"                            │"overlap"│
╞══════════════════════════════════════╪══════════════════════════════════════╪═════════╡
│"A New Wave of Covid-19 Is Coming. Her│"A New Covid Mystery"                 │4        │
│e’s How to Prepare."                  │                                      │         │
├──────────────────────────────────────┼──────────────────────────────────────┼─────────┤
│"Russia Asked China for Military and E│"U.S. Officials Say Superyacht Could b│3        │
│conomic Aid for Ukraine War, U.S. Offi│e Putin’s"                            │         │
│cials Say"                            │                                      │         │
├──────────────────────────────────────┼──────────────────────────────────────┼─────────┤
│"Satellite images show bodies lay in B│"A makeup artist recognized this Bucha│2        │
│ucha for weeks, despite Russian claims│ victim’s picture by her manicure."   │         │
│."                                    │                                      │         │
├──────────────────────────────────────┼──────────────────────────────────────┼─────────┤
│"Satellite images show bodies lay in B│"Russian soldiers opened fire on a cyc│2        │
│ucha for weeks, despite Russian claims│list in Bucha, new video shows."      │         │
│."                                    │                                      │         │
├──────────────────────────────────────┼──────────────────────────────────────┼─────────┤
│"New York Judge Dies by Suicide After │"Sarah Lawrence Cult Leader Convicted │2        │
│Authorities Search His Home"          │of Trafficking and Extortion"         │         │
└──────────────────────────────────────┴──────────────────────────────────────┴─────────┘
----
...
│"t1"             │"t2"             │"score"│"topics"                  │
╞═════════════════╪═════════════════╪═══════╪══════════════════════════╡
│"A New Wave of C"│"A New Covid Mys"│4      │["Coronavirus (2019-nCoV)"│
│                 │                 │       │,"Disease Rates","Tests (M│
│                 │                 │       │edical)","Coronavirus Omic│
│                 │                 │       │ron Variant"]             │
├─────────────────┼─────────────────┼───────┼──────────────────────────┤
│"Russia Asked Ch"│"U.S. Officials "│3      │["Embargoes and Sanctions"│
│                 │                 │       │,"Russian Invasion of Ukra│
│                 │                 │       │ine (2022)","United States│
│                 │                 │       │ International Relations"]│
├─────────────────┼─────────────────┼───────┼──────────────────────────┤
│"Satellite image"│"A makeup artist"│2      │["Civilian Casualties","Ru│
│                 │                 │       │ssian Invasion of Ukraine │
│                 │                 │       │(2022)"]                  │
├─────────────────┼─────────────────┼───────┼──────────────────────────┤
│"Satellite image"│"Russian soldier"│2      │["Civilian Casualties","Ru│
│                 │                 │       │ssian Invasion of Ukraine │
│                 │                 │       │(2022)"]                  │
├─────────────────┼─────────────────┼───────┼──────────────────────────┤
│"New York Judge "│"Sarah Lawrence "│2      │["Human Trafficking","Sex │
│                 │                 │       │Crimes"]                  │
└─────────────────┴─────────────────┴───────┴──────────────────────────┘
----
...
----
╒═════════════════════════════════╤═════════════════════════════════╤═══════╕
│"a1.title"                       │"a2.title"                       │"score"│
╞═════════════════════════════════╪═════════════════════════════════╪═══════╡
│"A New Wave of Covid-19 Is Coming│"A New Covid Mystery"            │22.0   │
│. Here’s How to Prepare."        │                                 │       │
├─────────────────────────────────┼─────────────────────────────────┼───────┤
│"Russia Asked China for Military │"U.S. Officials Say Superyacht Co│18.5   │
│and Economic Aid for Ukraine War,│uld be Putin’s"                  │       │
│ U.S. Officials Say"             │                                 │       │
├─────────────────────────────────┼─────────────────────────────────┼───────┤
│"Satellite images show bodies lay│"A makeup artist recognized this │16.0   │
│ in Bucha for weeks, despite Russ│Bucha victim’s picture by her man│       │
│ian claims."                     │icure."                          │       │
├─────────────────────────────────┼─────────────────────────────────┼───────┤
│"Russian Blunders in Chernobyl: ‘│"They Died by a Bridge in Ukraine│16.0   │
│They Came and Did Whatever They W│. This Is Their Story."          │       │
│anted’"                          │                                 │       │
├─────────────────────────────────┼─────────────────────────────────┼───────┤
│"Satellite images show bodies lay│"They Died by a Bridge in Ukraine│16.0   │
│ in Bucha for weeks, despite Russ│. This Is Their Story."          │       │
│ian claims."                     │                                 │       │
└─────────────────────────────────┴─────────────────────────────────┴───────┘
----
...
We can either do that as part of the import or as a post-processsing step, which is shown here.
